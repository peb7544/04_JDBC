...
import edu.kh.jdbc.board.mode.service.BoardService;
...
public class BoardView {
	...
	public void selectBoard() {
		...
		try {
			...
			// 2) 댓글 수정 - 누가 몇번 게시글에있는 몇던 댓글을 수정할 것인가?
			// 3) 댓글 삭제 - 누가 몇번 게시글에있는 몇던 댓글을 삭제할 것인가?
	...
	public void updateBoard(int boardNo) {
		...
		try {
			...
			// 게시글 수정 서비스 호출
			int result = boardService.updateBoard(boardTitle, boardNo, sb.toString());
