...
public class EmployeeView {
	...
	public void selectDeptTotalSalary() throws Exception {
		...
		empMap = service.selectDeptTotalSalary();
		
		List<String> keySet = new ArrayList<>(empMap.keySet());
	...
	/** 직급별 급여 평균 조회
	 * 대표 : 8000000원 ... 사원 : 2017500.0원(소수점 첫째자리)
	...
	public void selectJobAvgSalary() throws Exception {
		...
		empMap = service.selectJobAvgSalary();
		
		List<String> keySet = new ArrayList<>(empMap.keySet());
		
		System.out.println("  직급명    | 급여" );
		System.out.println("------------------ ");
